...
If Not fso.FileExists(py) Then py = "C:\Users\Box One\AppData\Local\Programs\Python\Python312\python.exe"
If Not fso.FileExists(py) Then py = root & ".venv\Scripts\pythonw.exe"
