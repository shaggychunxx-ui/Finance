...
AGENT_REGISTRY: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "primary_output": "economy.json",
        "sidecars": ["economy_com_resources.json"],
        "sources": ["economy.com (Moody's Analytics)", "Yahoo Finance API"],
        "owner": "platform",
    },
    {
        "command": "datascience",
...
DATA_SOURCES: list[dict[str, Any]] = [
    ...
    {
        "id": "economy_com",
        "name": "economy.com (Moody's Analytics)",
