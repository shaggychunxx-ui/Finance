...
AGENT_REGISTRY: list[dict[str, Any]] = [
    ...
    {
        "command": "fundamental-analyst",
        "agent": "Fundamental Analyst Agent (The Grounding Force)",
        "primary_output": "fundamental_analyst.json",
        "sidecars": ["sector_valuation_baselines.json"],
        "sources": ["SEC EDGAR companyfacts XBRL API", "Yahoo Finance Chart API"],
        "owner": "platform",
    },
    {
        "command": "sentiment-alt-data",
        "agent": "Sentiment & Alternative Data Agent (The Psychology Tracker)",
        "primary_output": "sentiment_alt_data.json",
        "sidecars": ["sentiment_lexicon.json"],
        "sources": ["Yahoo Finance per-symbol headline RSS feed"],
        "owner": "platform",
    },
    {
        "command": "technical-pattern",
        "agent": "Technical Analysis & Pattern Recognition Agent (The Execution Mapper)",
        "primary_output": "technical_pattern.json",
        "sidecars": ["technical_indicator_config.json"],
        "sources": ["Yahoo Finance Chart API"],
        "owner": "platform",
    },
    {
        ...
        "primary_output": "market_regime.json",
        "sidecars": ["regime_playbook.json"],
        "sources": ["Yahoo Finance Chart API"],
        "owner": "platform",
    },
    {
        "command": "adversarial-debate",
        "agent": "Adversarial Debate & Consensus Router (The Judge)",
        "primary_output": "adversarial_debate.json",
        "sidecars": ["consensus_scoring_weights.json"],
        "sources": ["Fundamental/Sentiment/Technical/Regime agent state"],
        "owner": "platform",
    },
    {
        "command": "risk-guardrail",
        "agent": "Risk Management & Guardrail Agent (The Ultimate Auditor)",
        "primary_output": "risk_guardrail.json",
        "sidecars": ["risk_guardrail_limits.json"],
