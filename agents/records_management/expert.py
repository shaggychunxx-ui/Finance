...
RECORD_SERIES: list[dict[str, Any]] = [
    ...
    {"pattern": "database_admin.json", "series": "stewardship_metadata", "agent": "database-admin"},
    {"pattern": "database_schema.json", "series": "reference_catalog", "agent": "database-admin"},
    {"pattern": "database_indexes.json", "series": "reference_catalog", "agent": "database-admin"},
    {"pattern": "data_processor.json", "series": "stewardship_metadata", "agent": "data-processor"},
    {"pattern": "processing_pipelines.json", "series": "reference_catalog", "agent": "data-processor"},
    {"pattern": "transformation_catalog.json", "series": "reference_catalog", "agent": "data-processor"},
    {"pattern": "data_entry.json", "series": "stewardship_metadata", "agent": "data-entry"},
    {"pattern": "entry_templates.json", "series": "reference_catalog", "agent": "data-entry"},
    {"pattern": "validation_rules.json", "series": "reference_catalog", "agent": "data-entry"},
