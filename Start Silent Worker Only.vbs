...
' Prefer pythonw (no console). Fall back to python.exe only if pythonw missing.
py = "C:\Users\Box One\AppData\Local\Programs\Python\Python312\pythonw.exe"
If Not fs.FileExists(py) Then py = "C:\Users\Box One\AppData\Local\Programs\Python\Python312\python.exe"
If Not fs.FileExists(py) Then py = venv & "\Scripts\pythonw.exe"
...
sh.Run """" & py & """ """ & worker & """ --service", 0, False
sh.Run """" & py & """ """ & ensure & """", 0, False
